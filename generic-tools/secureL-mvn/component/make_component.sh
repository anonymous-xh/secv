...
readonly LANGUAGE_PATH="$COMPONENT_DIR/$JRE/languages/secl"
#if [[ -f ../native/slnative ]]; then
#    INCLUDE_SLNATIVE="TRUE"
#fi

rm secL-component.jar

rm -rf COMPONENT_DIR

mkdir -p "$LANGUAGE_PATH"
cp ../language/target/securelanguage.jar "$LANGUAGE_PATH"
...
{
    echo "Bundle-Name: Secure Language";
    echo "Bundle-Symbolic-Name: com.oracle.truffle.secl";
...
$JAVA_HOME/bin/jar cfm ../secL-component.jar META-INF/MANIFEST.MF .

echo "bin/secl = ../$JRE/languages/secl/bin/secl" > META-INF/symlinks
#if [[ $INCLUDE_SLNATIVE = "TRUE" ]]; then
#    echo "bin/slnative = ../$JRE/languages/sl/bin/slnative" >> META-INF/symlinks
#fi
$JAVA_HOME/bin/jar uf ../secL-component.jar META-INF/symlinks

{
    echo "$JRE"'languages/secl/bin/secl = rwxrwxr-x'
    #echo "$JRE"'languages/sl/bin/slnative = rwxrwxr-x'
} > META-INF/permissions
$JAVA_HOME/bin/jar uf ../secL-component.jar META-INF/permissions
)
rm -rf $COMPONENT_DIR
