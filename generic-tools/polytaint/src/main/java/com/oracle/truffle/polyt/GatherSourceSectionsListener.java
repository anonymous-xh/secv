 ...
 *
 * Because we
 * {@link PolyTaintInstrument#enable(com.oracle.truffle.api.instrumentation.TruffleInstrument.Env)
...
final class GatherSourceSectionsListener implements LoadSourceSectionListener {
    ...
    private final PolyTaintInstrument instrument;

    GatherSourceSectionsListener(PolyTaintInstrument instrument) {
     ...
     *              {@link PolyTaintInstrument#coverageMap} up to date.
     */
    @Override
